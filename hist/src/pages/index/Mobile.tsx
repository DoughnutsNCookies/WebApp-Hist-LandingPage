    ...
    return (
        <section id="mobile">
            <div className="flex flex-col justify-center gap-y-6 items-center bg-white">
                <h1 className="font-bold text-9xl tracking-tighter text-[#46CCF6] pb-4">Just 4 steps</h1>
...
const MobileUpper = (props: MobileUpperProps) => {
    ...
    return (
        <div>
            <h1 className="text-backgroundColor text-4xl text-center pb-4">
    ...
    return (
        <div>
            <Image
                ...
                priority
            />
            <h1 className="text-backgroundColor tracking-tighter text-4xl text-center">
                <strong className="text-8xl font-bold pr-4">{step}</strong>
                {title}
            </h1>
        </div>
